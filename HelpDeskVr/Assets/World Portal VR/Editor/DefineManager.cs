...
{
	const string DEF_MANAGER_PATH = "Assets/World Portal VR/Editor/DefineManager.cs";
	const string SCRIPT_PATH = "Assets/World Portal VR/Scripts/Portal.cs";
	...
	void OnGUI() {
		...
		var text = new string[] { "Standard FPS (Non-VR)", "Steam VR (Vive)", "Open VR (Gear VR)" };
