...
public class Global : MonoBehaviour {
    ...
    void Update() {
        ...
        totalFrames++;
        if (totalFrames % 6 == 0)
            fractals.FindChild("Static Noise Fractal Quad").GetComponent<MeshRenderer>().material.SetFloat("juliaConstantImaginary", Random.Range(0.0f, 1.0f));
    }
    ...
    public void colouredBackgroundSliderValueChanged(float value) {
        fractals.FindChild("Coloured Background Fractal Quad").GetComponent<MeshRenderer>().material.SetFloat("backgroundColourAmount", value);
    ...
    public void toggleSmooth(bool smooth) {
        fractals.FindChild("Smoothing Fractal Quad").GetComponent<MeshRenderer>().material.SetInt("smoothing", smooth ? 1 : 0);
    }
    public void iterationsPerPixelSliderValueChanges(float value) {
        fractals.FindChild("Iterations Fractal Quad").GetComponent<MeshRenderer>().material.SetInt("iterations", (int) value);
    ...
    public void sunsetSliderValueChanged(float value) {
        MeshRenderer meshRenderer = fractals.FindChild("Sunset Fractal Quad").GetComponent<MeshRenderer>();
    ...
    public void flowerSliderValueChanged(float value) {
        MeshRenderer meshRenderer = fractals.FindChild("Flower Fractal Quad").GetComponent<MeshRenderer>();
    ...
    public void starFieldBlackSliderValueChanges(float value) {
        MeshRenderer meshRenderer = fractals.FindChild("Star Field Fractal Quad").GetComponent<MeshRenderer>();
